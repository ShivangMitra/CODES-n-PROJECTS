...
<body>
    ...
    <div class="position-relative overflow-hidden p-3 p-md-5 m-md-3 text-center bg-light">
        <div class="col-md-5 p-lg-5 mx-auto my-5">
            <h1 class="display-4 font-weight-normal">Chatroom-Z</h1>
            <p class="lead font-weight-normal">Chat with your friends without worrying about privacy and chat logs. You
                can chat on our platform for free.</p>
            <form action="claim.php" method="post">
                <div class="form-group row" style="margin-left: 40px;">
                    <label for="colFormLabel" class="col-sm-2 col-form-label">chatroomz.com/</label>
                    <div class="col-sm-8" style="margin-left: 40px;">
                        <input type="text" class="form-control" name="room" placeholder="example">
                    </div>
                </div>
